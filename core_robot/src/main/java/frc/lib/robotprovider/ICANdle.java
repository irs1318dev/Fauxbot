...
public interface ICANdle
{
     ...
     * @param proportion What proportion of LEDs can be on at any point [0.1, 1.0]
     * @param ledOffset  Where to start the animation
     */
    void startTwinkleAnimation(int animSlot, int r, int g, int b, int w, double speed, int numLed, double proportion, int ledOffset);
     ...
     * @param ledOffset  Where to start the animation
     */
    void startTwinkleOffAnimation(int animSlot, int r, int g, int b, int w, double speed, int numLed, double proportion, int ledOffset);
