...
public class PathPlannerRotationTarget implements IPathPlannerGoal
{
    ...
    /**
     * Creates an instance of the PathPlannerRotationTarget class instructing the robot to face the specified orientation at the percentage between the
     * previous waypoint and the subsequent one.
     * 
