...
10. [Writing a new Mechanism](RobotCodeInstructions/WritingMechanisms.md)
11. [Adding Macros](RobotCodeInstructions/AddingMacros.md)
12. [Adding Autonomous Routines](RobotCodeInstructions/AddingAutonomousRoutines.md)
13. [Composing Tasks together](RobotCodeInstructions/ComposingTasksTogether.md)
14. [Updating ButtonMap](RobotCodeInstructions/UpdatingButtonMap.md)
15. [Writing Tasks](RobotCodeInstructions/WritingControlTasks.md)

# [Fauxbot Exercises](FauxbotExercises/FauxbotExercises.md)
