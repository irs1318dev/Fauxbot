...
public abstract class FauxbotTalonXBase extends FauxbotAdvancedMotorBase
{
    ...
    public void setSensorType(TalonXFeedbackDevice feedbackDevice)
    {
        ...
        {
            this.innerEncoder = new FauxbotEncoder(new FauxbotSensorConnection(FauxbotSensorConnection.SensorConnector.CAN, FauxbotTalonXBase.class, this.connection.getPort()));
        }
    }
